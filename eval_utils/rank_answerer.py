...
def rankABot(aBot, dataset, split, scoringFunction, exampleLimit=None, useNDCG=False, num_workers=2):
    '''
    ...
    for idx, batch in enumerate(dataloader):
        ...
        if useNDCG or split == 'test':
            ...
            for i in range(len(img_ids)):
                ...
                # "ranks": [rank.item() for rank in ranks_cur[i][batch["num_rounds"][i] - 1]]
                ...
                if split == "test":
                    ...
                    for j in range(numRounds):
                        ranks_json.append({
                            ...
                            "round_id": int(j + 1),
                            "ranks": [rank.item() for rank in ranks_cur[i][j]]
                        })
